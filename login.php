...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "Usuário selecionado: " . $user["id"] . " - " . $user["name"] . "<br>";
        echo "Senha: " . $password . "<br>";
        echo "Hash da senha: " . $user["password"] . "<br>";
        ...
        if (password_verify($password, $user["password"])) {
            ...
            // Redirecionar para a página de carrinho ou área do administrador
            if ($user["role"] == "admin") {
...
<body class="body">
    ...
    <div class="container">
        ...
        <form class="form-acc" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Não tem conta? <a href="criar_conta.php">Criar conta</a></p>
        </form>
    </div>
